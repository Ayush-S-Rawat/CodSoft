...
public:
    ...
    void hal_name()
    {
        ...
        {
            case 1:
            hall_name="INOX DELHI";
            break;
             case 2:
            hall_name="CINEPOLIS DELHI";
            break;
             case 3:
            hall_name="PVR";
            break;
...
void movie_booking::show()
{
    ...
    (*p)=m;
     ofstream fout;
    fout.open("movie_data.csv",ios::app);
for(i=0;i<m;i++)
{   fflush(stdin);
...
{
 ofstream fout;
    fout.open("user_credential.csv",ios::app);
...
int movie_booking::password_check()
{
     cout<<"\n\n\t\t\t\t\t\t\tENTER YOUR USER ID\n";
            ...
            cin>>cus_id;
 ifstream myfile;
            myfile.open("user_credential.csv");
                while(!myfile.eof())
            {
                getline(myfile,user,',');
                getline(myfile,user,',');
...
int main()
{
    ...
    while(1)
    {
        cout<<"\n\n\t\t\t\t\t\t\t PRESS 1 TO BOOK TICKET IN INOX DELHI";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 2 TO BOOK TICKET IN CINEPOLIS DELHI";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 3 TO BOOK TICKET IN PVR";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 4 TO BOOK TICKET IN WAVE";
    ...
    switch(obn)
    {
        case 1:
            cout<<"\t\t\t\t\t\t\t";
            cout<<"INOX DELHI IS SELECTED\n";
        obj[0].first();
        break;
        case 2:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"CINEPOLIS DELHI IS SELECTED\n";
        obj[1].first();
        break;
        case 3:
        cout<<"\t\t\t\t\t\t\t";
             cout<<"PVR DELHI IS SELECTED\n";
        obj[2].first();
        break;
        case 4:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"WAVE DELHI IS SELECTED\n";
        obj[3].first();
        break;
        case 9:
                goto bye;
